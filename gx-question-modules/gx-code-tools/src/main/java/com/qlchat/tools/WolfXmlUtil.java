 ...
 * <b>版权有：<b>版权(C) 2011，QQ 21828096<br>
 * 
 */
public class WolfXmlUtil {
	   ...
	   /**
		 *  用XPath.selectSingleNode(root,xpath)方法来查询具体某个节点
			...
			Element findelement=(Element)XPath.selectSingleNode(root,"/root/biaodan[@bdname='"+chkname+"'] | /root/biaodan[@liuname='"+flowname+"']"); 
		          如果有多个节点，用/区分，如：book[@url='dom4j.com']/title[@id='123']
		    element.asXML() 输出
		*/
		int count=0;
		Document document=this.getPath(filePath, "UTF-8");
	...
	public static void main(String[] args){
		...
		String filePath1="D:\\MyEclipse 8.5\\sm\\src\\com\\mylu\\sm\\conf\\sqlmap\\ProUserSQL.xml";
		//String filePath="D:\\MyEclipse 8.5\\sm\\src\\com\\mylu\\sm\\conf\\struts2\\struts2-sm-proWbType.xml";
		try{
